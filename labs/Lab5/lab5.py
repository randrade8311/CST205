...
monaLisaIm = Image.new('L', (400,500))
...
"""for x in range(width):
	for y in range(height):
		val = (secrets.choice(mona_list))
	monaLisaIm.putpixel((x,y), (val))
"""
"""for x in range(width):
	for y in range(height):
		pixel_list.append(monaLisaIm.getpixel((x,y)))
	monaLisaIm.putpixel((x,y), bytes(mona_list))
"""
monaLisaIm = Image.frombytes('L', (18,19), bytes(mona_list))
monaLisaIm.save("monalisa1.jpg")
